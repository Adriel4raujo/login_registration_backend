...
import com.adriel.loginregistrationbackend.email.EmailSender;
import com.adriel.loginregistrationbackend.email.EmailService;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequestDTO registrationRequestDTO) {
        ...
        final String LINK = "http://localhost:8081/api/v1/registration/confirm?token=" + token;

        emailSender.send(registrationRequestDTO.getEmail(),
                buildEmail(registrationRequestDTO.getFirstName(), LINK));
